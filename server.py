...
from tools.render_tools import (
    ...
    impl_generate_animation_compat,
    impl_generate_chart,
...
TOOL_HANDLERS = {
    ...
    "blender_generate_latex":         impl_generate_latex_compat,
    "blender_generate_ui_mockup":     impl_generate_ui_mockup,
    "blender_generate_animation":     impl_generate_animation_compat,
